...
private final static int DEFAULT_SELECTION_LEN = 5;
	...
	private MenuListener listener;//对外监听字典查询接口
	...
	public void copyText(String selectedText){
		if(listener == null){
			throw new RuntimeException("MenuListener is null");
		}
		listener.onCopy(selectedText);
	}
	/**
	 * 调用浏览器功能
	 * @param selectedText
	 */
	public void browser(String selectedText){
		if(listener == null){
			throw new RuntimeException("MenuListener is null");
		}
		listener.onBrowser(selectedText);
	}
	 ...
	 * @param selectedText
	 */
	public void dictSearch(String selectedText){
		if(listener == null){
			throw new RuntimeException("MenuListener is null");
		}
		listener.onDictSearch(selectedText);
	}
...
//			Log.d("x:y", mStartHandle.getCurX() + "-" + mEndHandle.getCurY());
	...
	public interface MenuListener{
		void onCopy(String selectedText);
		
		void onDictSearch(String selectedText);
		
		void onBrowser(String selectedText);
	}
	/**
